...
while True:
    ...
    cv2.circle(frame_ROI, set_points[0], 5, (0, 255, 0), 1)
    # transform set points in new plane
    IPM_set_points = cv2.perspectiveTransform(set_points, H)
    cv2.circle(frame_ROI_IPM, IPM_set_points[0], 5, (255, 0, 0), 1)
