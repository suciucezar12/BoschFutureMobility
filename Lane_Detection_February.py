...
class LaneDetection:
    ...
    def get_warp(self, frame_cropped):  # from trapezoid to rectangle
        ...
        source_coords = np.float32([(640, 480), (0, 480), (self.y_top_left_trapezoid, self.x_top_trapezoid),
                         (self.y_top_right_trapezoid, self.x_top_trapezoid)])

        destination_coords = np.float32([ (640, 480), (0, 480), (0, self.x_top_trapezoid), (640, self.x_top_trapezoid)])
