...
class LaneDetection:
    ...
    def get_and_filter_lines(self, frame_ROI_preprocessed, frame_ROI):
        lines = cv2.HoughLinesP(frame_ROI_preprocessed, rho=0.5, theta=np.pi / 180, threshold=55, minLineLength=20,
                                         maxLineGap=80)
        left_lines = []
        right_lines = []
    ...
    def run(self):
        ...
        while True:
            ...
            cv2.imshow("Frame_ROI Preprocessed", frame_ROI_preprocessed)
