...
class LaneDetection:
    ...
    def both_lines_detected(self, left_line_coefficients, right_line_coefficients, frame_ROI):
        ...
        cv2.line(frame_ROI, (int(frame_ROI.shape[1] / 2) - 50, frame_ROI.shape[0]), (y_cv_vanishing_point, x_cv_theta), (232, 32, 1), 5)
    ...
    def only_one_line_detected(self, line_coefficients, frame_ROI, is_left_line=True):
        ...
        cv2.line(frame_ROI, (int(frame_ROI.shape[1] / 2) - 50, frame_ROI.shape[0]), (y_cv_vanishing_point, x_cv_theta),
                 (232, 32, 1), 5)
    ...
    def get_theta(self, frame_ROI_preprocessed, frame_ROI):
        ...
        if found_line:
            ...
            y_cv_center = int(frame_ROI.shape[1] / 2) - 50  # camera lasata in partea stanga
