...
class LaneDetection:
    ...
    def polyfit(self, lines):
        ...
        for line in lines:
            ...
            x_points.append(line[0][1])
            x_points.append(int(abs(line[0][0] - self.height)))
            y_points.append(line[0][3])
            y_points.append(int(abs(line[0][2] - self.height)))
        ...
        while True:
            ...
            if left_lines_detected is not None:
                ...
                if coeff is not None:
                    ...
                    cv2.line(frame, (480, y1), (0, y2), (21, 32, 2), 5)
            if right_lines_detected is not None:
